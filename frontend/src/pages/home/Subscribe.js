...
import b14 from '../../assets/images/banners/b14.png'
const Subscribe = () => (
    <section className="section-subscribe padding-y-lg" style={{ backgroundImage: `url(${b14})`,backgroundColor:"#041e42" }}>
                ...
                <div className="col-lg-5 col-md-6">
                    <form className="form-row">
                        ...
                        <div className="col-md-4 col-5">
                            <button type="submit" className="btn btn-block btn-success"> <i className="fa fa-envelope"></i> Subscribe </button>
                        </div>
                    </form>
