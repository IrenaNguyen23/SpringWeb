                ...
                <div className="category-item-container has-scrollbar">
                    ...
                    <div className="category-item">
                        ...
                        <div className="category-img-box">
                            <img src={LuuNiem} alt="dress & frock" width="30" />
                        </div>
                    ...
                    <div className="category-item">
                        ...
                        <div className="category-img-box">
                            <img src={MoHinh} alt="winter wear" width="30" />
                        </div>
                    ...
                    <div className="category-item">
                        ...
                        <div className="category-img-box">
                            <img src={Electric} alt="glasses & lens" width="30" />
                        </div>
                    ...
                    <div className="category-item">
                        ...
                        <div className="category-img-box">
                            <img src={Clothing} alt="shorts & jeans" width="30" />
                        </div>
