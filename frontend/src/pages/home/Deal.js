    ...
    return (
        <>
            <div className="product-featured">
                ...
                <h2 className="title"><Link to="/offers?page=1">Deal of the day</Link></h2>
                            ...
                            <div className="showcase-container" key={row.id}>
                                ...
                                <Link to={`/detail?productId=${row.id}`}>
                                    <div className="showcase-banner">
                                        <img src={`./images/items/${row.thumbnail}`} alt="shampoo, conditioner & facewash packs" className="showcase-img" />
                                    </div>
                                </Link>
                                    ...
                                    <div className="showcase-content">
                                        ...
                                        <Link to={`/detail?productId=${row.id}`}>
                                            <h3 className="showcase-title">{row.title}</h3>
                                        </Link>

                                        <p className="showcase-desc">
                                            Cute Siu Cap Vip Pro
                                        </p>
